...
public class FriendsDetail extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(edu.pitt.is.UMAP2015.R.layout.userdetail);
        ...
        name = (TextView) findViewById(edu.pitt.is.UMAP2015.R.id.name);
        position = (TextView) findViewById(edu.pitt.is.UMAP2015.R.id.position);
        organization = (TextView) findViewById(edu.pitt.is.UMAP2015.R.id.organization);
        country = (TextView) findViewById(edu.pitt.is.UMAP2015.R.id.country);
        linkedin = (TextView) findViewById(edu.pitt.is.UMAP2015.R.id.linkedin);
        action = (Button) findViewById(edu.pitt.is.UMAP2015.R.id.action);
        statusdis = (TextView) findViewById(edu.pitt.is.UMAP2015.R.id.status);
