    ...
    private class MyListAdapter extends BaseAdapter implements
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = li.inflate(edu.pitt.is.UMAP2015.R.layout.list_item, null);
//                convertView.
                ...
                convertView.findViewById(edu.pitt.is.UMAP2015.R.id.time).setVisibility(View.GONE);
                convertView.findViewById(edu.pitt.is.UMAP2015.R.id.author).setVisibility(View.GONE);
                convertView.findViewById(edu.pitt.is.UMAP2015.R.id.type).setVisibility(View.GONE);
//                //holder.recommend = (TextView) convertView.findViewById(R.id.recommend);
                convertView.findViewById(edu.pitt.is.UMAP2015.R.id.ImageButton01).setVisibility(View.GONE);

                convertView.findViewById(edu.pitt.is.UMAP2015.R.id.ImageButton02).setVisibility(View.GONE);
